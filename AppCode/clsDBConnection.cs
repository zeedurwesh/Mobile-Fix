...
public class clsDBConnection
{
    ...
    public clsDBConnection()
    {
        ...
        //connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\AppData\\MobileFixNew.mdf;Integrated Security=True;Connect Timeout=30";
    }
    ...
    public string GetDBName()
    {
        ...
        do
        {
            ...
            while (PathArrayIndex < filePaths.Length & Found == false)
            {
                ...
                if (filePaths[PathArrayIndex].Contains("appdata") == true)
                {
                    //get the list of files in the folder
                    dirConts = System.IO.Directory.GetFiles(filePaths[PathArrayIndex], "MobileFixNew.mdf", System.IO.SearchOption.AllDirectories);
                    Counter = 0;
